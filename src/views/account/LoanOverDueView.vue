...
<template>
  <UserLayout>
    <h1 class="text-4xl mb-4 pl-[60px] font-semibold capitalize mt-[10px]">Loan over due</h1>
    <div class="flex justify-end pr-[50px]">
      <div>
        <img @click="printTable()" alt="Vue logo" class=" w-11 h-11 mr-[2px] cursor-pointer" src="@/assets/icon/print.svg" />
        <p class="text-[20px]">prinf</p>
      </div>
    </div>
        ...
        <div class="flex mb-4 ">
          <div class="stats w-full shadow">
            <div class="stat">
              ...
              <div class="stat-title font-medium">OS</div>
            ...
            <div class="stat">
              ...
              <div class="stat-title font-medium">Loans</div>
              <div class="stat-value">{{ accountStore.loanOverdues.loans }}</div>
            </div>
            <div class="stat">
              <div class="stat-figure text-secondary cursor-pointer">
              ...
              <div class="stat-title font-medium">Nomal loans</div>
        ...
        <div class="flex flex-col md:flex-row gap-2">
          <div class="flex-1">
            <div class="card w-2/3 p-6 bg-white shadow-xl">
              ...
              <apexchart type="bar" :options="accountStore.barOption.options" :series="accountStore.barOption.series">
              </apexchart>
            </div>
          </div>
          <div class="flex-1">
            <div class="card w-2/3 p-6 bg-white shadow-xl">
              <h1 class="text-[20px]">គុណភាពកម្ចី</h1>
